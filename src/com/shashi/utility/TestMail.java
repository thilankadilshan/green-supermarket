...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "greensupermarkets.lk@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Green Supermarkets</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Green Supermarkets.<br>"
					+ "We are glad that you choose <bold>us. We invite you to check out our latest collection of new groceries."
					+ "<br>We are providing upto 60% OFF on most of the electronic gadgets. So please visit our site and explore the groceries. <br>"
					+ " <br>Our Online groceries is growing in a larger amount these days and we are in high demand so we thanks all of you for "
					...
					+ "<span class='greenText'>groceries500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
