...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #43b341; color: white; padding: 5px;">
		<h2>Green supermarket</h2>
		<h6>We specialize in All products</h6>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=Bakery">Bakery</a></li>
							<li><a href="index.jsp?type=Beverage">Beverage</a></li>
							<li><a href="index.jsp?type=Pharmacy">Pharmacy</a></li>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="userHome.jsp?type=Bakery">Bakery</a></li>
							<li><a href="userHome.jsp?type=Beverage">Beverage</a></li>
							<li><a href="userHome.jsp?type=Pharmacy">Pharmacy</a></li>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=Bakery">Bakery</a></li>
							<li><a href="adminViewProduct.jsp?type=Beverage">Beverage</a></li>
							<li><a href="adminViewProduct.jsp?type=Pharmacy">Pharmacy</a></li>
