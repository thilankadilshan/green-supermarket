				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="bakery"
								<%="bakery".equalsIgnoreCase(ptype) ? "selected" : ""%>>Bakery</option>
							<option value="Beverage"
								<%="Beverage".equalsIgnoreCase(ptype) ? "selected" : ""%>>Beverage</option>
							<option value="Pharmacy"
								<%="Pharmacy".equalsIgnoreCase(ptype) ? "selected" : ""%>>Pharmacy</option>
